...
import com.example.keepaccount.DataSource.TutorialDataSource
...
val databaseModule =
    module {
        ...
        factory { get<KeepAccountRoomDatabase>().getTutorialShownStateDao() }
        ...
        factory<ITutorialDataSource> { TutorialDataSource(get(), get(koinIO)) }
    }
